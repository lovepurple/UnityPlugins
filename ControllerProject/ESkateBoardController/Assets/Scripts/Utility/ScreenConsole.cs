...
public class ScreenConsole : MonoBehaviour
{
    ...
    /// </summary>
    public float shakeAcceleration = 10f;
    ...
    private float m_lastToggleTime = 0;
    ...
    {
        if (shakeToOpen && Input.acceleration.sqrMagnitude > shakeAcceleration && Time.time - m_lastToggleTime > 1)
        {
            isVisible = !isVisible;
