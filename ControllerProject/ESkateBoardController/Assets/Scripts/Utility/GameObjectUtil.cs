...
namespace EngineCore
{
    ...
    public static class GameObjectUtil
    {
        ...
        /// </summary>
        /// <param name="transform"></param>
        /// <param name="childGameObjectName"></param>
        public static GameObject AddChildGameObject(Transform transform, string childGameObjectName)
        {
            GameObject childGameObject = new GameObject(childGameObjectName);
        ...
        public static T GetComponent<T>(this Transform transfrom, string childGameObjectName) where T : Component
        {
            Transform childTransfrom = transfrom.Find(childGameObjectName);
            if (childTransfrom == null)
                return null;

            T componentOnChild = childTransfrom.GetComponent<T>();
